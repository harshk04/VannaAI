...
# Streamlit app title
st.title("VannaQuery App")

# Input for API key
api_key = st.text_input("Enter your Vanna API Key: (E-mail)", type="default")

# Input for user question
user_question = st.text_input("Enter your query of data:")
    ...
    if api_key and user_question:
        try:
            ...
            with st.spinner('Thinking...'):
                ...
                with st.expander("Vanna.AI Response"):
                    st.write(response)
